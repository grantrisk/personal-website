            ...
            <main className={styles.main}>
                <section className={styles.sectionHeader}>
                    <div className={styles.textContainer}>
                        ...
                        <br/>
                        <p>
                            I&apos;m a software engineer based in Wilmington, North Carolina... scraping together enough
                            documentation to explain to my parents what I actually do for a living.
                        </p>
                    </div>
